...
class ICMTrainer(BaseRLTrainer):
    ...
    def _setup_actor_critic_agent(self, ppo_cfg: Config) -> None:
        ...
        self.forward_dynamics_optimizer = torch.optim.Adam(self.forward_dynamics.parameters(), lr=self.config.RL.EME.encoder_lr)
    ...
    def _update_agent(self):
        ...
        if self.config.RL.EME.inv_dynamics_epochs > 0:
            ...
            fwd_dynamics_loss /= self.config.RL.EME.inv_dynamics_epochs
