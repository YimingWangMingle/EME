...
class EMETrainer(BaseRLTrainer):
    def __init__(self, config: Optional[Config] = None):
        ...
        # Initialize components from EME
    ...
    def _compute_eme_metric(self, step_batch):
        ...
        # Cosine similarity distance from EME
        ...
        # Reward prediction loss using StateRewardDecoder
        ...
        # Combine metrics to get EME
        eme_metric = cosine_dist + self.kl_coef * kl_div + reward_loss
        return eme_metric
