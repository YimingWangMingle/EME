...
class RNDTrainer(BaseRLTrainer):
    ...
    def _setup_actor_critic_agent(self, ppo_cfg: Config) -> None:
        ...
        self.predictor_net_optimizer = torch.optim.Adam(self.predictor_net.parameters(), lr=self.config.RL.EME.encoder_lr)
    ...
    def _update_agent(self):
        ...
        if self.config.RL.EME.inv_dynamics_epochs > 0:
            rnd_loss /= self.config.RL.EME.inv_dynamics_epochs
